...
const main = document.querySelector(".contenedor main");
...
noticias.forEach(noticia => {
    ...
    <section class="noticia">
        <span class="fecha">${noticia.fecha.getDate()} / ${noticia.fecha.getMonth() + 1} / ${noticia.fecha.getFullYear()}</span>
    ...
    main.innerHTML += `
    <section class="noticia noticiaInternacional">
        <span class="fecha">${noticia.fecha.getDate()} / ${noticia.fecha.getMonth() + 1} / ${noticia.fecha.getFullYear()}</span>
        <h3>${noticia.titulo}</h3>
        <img src="${noticia.imgUrl}">
        <p >${noticia.descripcion}</p>
...
for (let user in usersBirthday) {
  if (today === usersBirthday[user]) {
    setTimeout(() => {
      // alert("Feliz cumpleaños " + user);
    }, 2000);
  }
}
...
//Devuelve un array a partir de un objeto
// const users = Object.keys(usersBirthday);
// const birthdays = Object.values(usersBirthday);

// Object.entries(usersBirthday).forEach(([key, value]) => {
...
//Tipos de funciones por su nombre:
//Expresada + funcion anonima

// const saludar = function(par1, par2) {
//   console.log("Hola")
// }
// saludar(par1, par2)

//Expresada + callback
// const saludar = (par1, par2) => {
//   console.log("Hola")
// }
// saludar(par1, par2)

//declaradas
// function saludar2(par1, par2) {
//   console.log("Hola2")
// }
// saludar(par1, par2)
